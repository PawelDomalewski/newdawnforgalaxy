export const sessions = [
  {
    ...
    image: "/images/070924.webp", // ← DODAJ ŚCIEŻKĘ DO ZDJĘCIA
  ...
  },
  {
    ...
    image: "/images/111024.webp", // ← DODAJ ŚCIEŻKĘ DO ZDJĘCIA
  ...
  },
  {
    ...
    image: "/images/130925.webp", // ← DODAJ ŚCIEŻKĘ DO ZDJĘCIA
  ...
  },
  {
    ...
    image: "/images/161025.webp", // ← DODAJ ŚCIEŻKĘ DO ZDJĘCIA
  ...
  },
  {
    ...
    image: "/images/181025.webp", // ← DODAJ ŚCIEŻKĘ DO ZDJĘCIA
    ...
    <ul>
    <li><h3>Galeria</h3></li>
    <div><img src="/images/sesje/18102025/1.webp"><img src="/images/sesje/18102025/2.webp"><img src="/images/sesje/18102025/3.webp"><img src="/images/sesje/18102025/4.webp"><img src="/images/sesje/18102025/5.webp"><img src="/images/sesje/18102025/6.webp"></div>
    <p class="session-summary-pkt">Punktacja:<br>
  ...
  },
  {
    ...
    image: "/images/311025.webp", // ← DODAJ ŚCIEŻKĘ DO ZDJĘCIA
    tags: ["Kosmos", "Epicka", "Długa gra"],
    fullContent: `<h3>Uczestnicy:</h3>
    <ol>
  ...
  },
  {
    ...
    image: "/images/sesje/081125/head.webp",
    tags: ["Akcja!"],
    fullContent: `<h3>Uczestnicy:</h3>
    <ol>
    <li>Ania - Postępowi Hydranie</li>
  ...
  },
  {
    ...
    image: "/images/sesje/13122025/head.webp",
    tags: ["Akcja!"],
    fullContent: `<h3>Uczestnicy:</h3>
    <ol>
    ...
    <p>W pierwszej rundzie gracze byli dość uprzejmi w swojej eksploracji, Paweł W mógł odkryć sektor z I kręgu pomiędzy centrum a homeworldem Piotra, ale tego nie zrobił, o czym go poinformował znaczącym tonem i wyrażnie dając do zrozumienia by pamiętał o tym.. Podobnie było w przypadku moim i Natana, również nie zablokowałem potencjalnego sojusznika w przyszłości. Udało mi się natomiast odkryć heks z Anomalią (wybrałem stronę mobilną, for fun), heks z podwójnymi starożytnymi i dwa nie bronione heksy. Wysłałem również mój myśliwiec w przyszłość, by powrócił w kolejnej rundzie.<br><br>
    Natan, grający Mechanemą (biały) odkrył jeden heks z II kręgu i z żetonem odkrycia po czym... Spasował ku zaskoczeniu wszystkich.<br><br>
    Piotr grający niebieskimi Hydran miał dość trudny początek, wylosował Rój Starożytnych w II kręgu i dwa statki Starożytnych w I kręgu.<br><br>
    Paweł W grający zielonymi Exiles (Wygnańcami) odkrył Starożytnych na I kręgu oraz dwa nie bronione heksy w II i III kręgu.<br><br>
    Tymek natomiast grający żółtymi Ludźmi odkrył bezpieczne heksy i zyskał dwa żetony odkryć przy tym, które zboostowały jego ekonomię. <br><br>
    Kacper z kolei, grający czarną Hegemonią Oriona, zajął najwięcej heksów, zyskując przy tym jeden darmowy żeton odkrycia.<br><br>
    ...
    <p>Dalsze eksploracje. Ja odkryłem heks broniony przez pojedynczego Starożytnego.<br><br>
    Natan - heks nie broniony, ale trzema planetami zaawansowanymi, heks z podwójnymi obcymi. Piotr - heks z różową planetą oraz heks z brązową planetą z żetonem odkrycia. Całkiem dobra sytuacja dla Hydran, jedynie brak planet ekonomicznych może doskwierać.<br><br>
    ...
    <p>Sytuacja zaczyna się rozkręcać. Kacper zbudował dwa krążowniki i mając łącznie trzy posłał je na GCDS - Galactic Center Defense System, szalony, brawurowy ruch. Ja z kolei zbudowałem krążownik i pancernik, drugi pancernik podróżując w czasie przybył mi na pomoc, także mając dwa pancerniki wysłałem je do walki z pojedynczym Starożytnym, krążownik został z tyłu by pilnować pozostałe heksy.<br><br>
    Natan stracił swój świat domowy na rzecz Starożytnych, zbudował więc dwa krążowniki, które czekały na odpowiedni moment. Piotr kontynuował eksploracje i odkrył heks z żetonem odkrycia, poza tym skupiał się na rozwoju technologicznym, podobnie jak Paweł W.<br><br> 
    Tymek dobudował jeden krążownik i myśliwiec i zaatakował heks przy centrum, z którym wcześniej nie poradził sobie Paweł W.<br><br>
    Tymkowi udało się wygrać, Kacper boleśnie przegrał walkę o centrum, dodatkowo został zaatakowany przez Rój na tyłach swego Imperium. Moje pancerniki natomiast wygrały bez problemu. Ostatni Starożytny z Roju między Mechanemą a Hydran wyleciał w kosmos zostawiając heks z żetonem odkrycia bez opieki. Anomalia wciąż słabła, zostając już tylko na 2 pkt życia.<br><br>
    ...
    <p>Połowa gry już za nami<br><br>
    Musiałem opłacić budowę pancernika, który pojawił się w trzeciej rundzie, przy okazji zbudowałem drugi krążownik. Flotą złożoną z dwóch pancerników, dwóch krążowników i jednego myśliwca ruszyłem na GCDS. Natan, Piotrek i Tymek skupili się na ulepszaniu swoich statków i technologii. Paweł W dobudował kolejny orbital i myśliwiec. Poza tym wysłał dwa krążowniki na centrum, by przeszkodziły mi w podboju. Śmiały, dobry i niespodziewany ruch z jego strony. Kacper w tym czasie dobudował jeden krążownik i mając dwa takie wysłał je do odbicia ziemi utraconej z rąk Starożytnych.<br><br>
    Walka Exiles z Dorado w centrum galaktyki zakończyła się zwycięstwem tych drugich, ale poniesione straty były na tyle duże, że nie udało mi się pokonać GCDS. Kacper pokonał dwóch Starożytnych i odzyskał swój heks.<br><br>
    Po pięciu rundach sytuacja na planszy wygląda następująco:<br><br>
    Dorado - 5 heksów kontrolowanych, zero floty, cała przepadła w walce o centrum, czeka mnie powolna odbudowa.<br><br>
    Mechanema - 4 heksy, dwa krążowniki, stabilna sytuacja.<br><br>
    Hydran - 5 heksów, dwa krążowniki i jeden myśliwiec, podobnie jak Natan, Piotrek ma stabilną sytuację. <br><br>
    Exiles - 4 heksy, stracił dwa krążowniki w partyzantce przeciw Dorado, ale jego pozycja jest conajmniej solidna, na każdym z heksów ma orbital, który funkcjonuje również jako baza gwiezdna, więc nie jest bezbronny.<br><br>
    Ludzie - 7 heksów, pancernik, trzy krążowniki, dwa myśliwce i baza gwiezdna. Liczby mówią same za siebie. Bardzo mocna pozycja wyjściowa Tymka do drugiej połowy gry.<br><br>
    ...
    <p class="session-summary"><b style="color: darkgreen;">Komentarz Pawła W - Exiles:</b><br><br>
    ...
    Natan wykupił technologię Zaawansowanych Planet Ekonomicznych oraz wybudował pancernik. Jego sytuacja wyglądała na stabilną i rozwijał się. Piotr wybudował dwa pancerniki i krążownik. Posiadał już pokażną flotę. Paweł W odbudował dwa krążowniki w sektorze I kręgu. Tymek wciąż rósł w siłę nie niepokojony przez nikogo. Zbudował jeden pancernik i krążownik, miał więc pełny limit czterech krążowników i dwóch pancerników, z tej floty wysłał trzy statki na centrum. Kacper zajął heks po Roju Starożytnych zyskując żeton odkrycia oraz kupił technologię Wormhole Generator.<br><br>
    Tymkowi udało się zdobyć środek galaktyki, zyskał w ten sposób 8 heks pod swoją kontrolę. Posiadał najwięcej heksów i największą flotę na ten moment gry.<br><br>
    Ta runda była dość spokojna, prawdziwa cisza przed burzą.
    </p>
    <li><h3>Runda 7</h3></li>
    <div>
    <img src="/images/sesje/13122025/13.webp"></img>
    <img src="/images/sesje/13122025/14.webp"></img>
    ...
    <li><h3>Runda 8</h3></li>
    <div>
    <img src="/images/sesje/13122025/17.webp"></img>
    <img src="/images/sesje/13122025/18.webp"></img>
    <img src="/images/sesje/13122025/19.webp"></img>
    </div>
    <h3>Burza przybierała na sile...</h3>
    <p>
    Kacper wleciał jednym krążownikiem na mój ostatni heks z III kręgu, a drugim na mój świat macierzysty. Ja w tym czasie po analizie schematów statków innych graczy kupiłem technologię Flux Missile, tanie, szybkie rakiety o małej sile rażenia, ale pozostali gracze mieli statki o małej ilość punktów życia, więc te rakiety powinny wystarczyć. Natan poleciał krążownikiem i pancernikiem na mój sektor I kręgu, gdzie wciąż był krążownik Tymka. Pancernikiem później poleciał dalej, do Kacpra, który desperacko bronił się budując Bazę Gwiezdną. Ja zacząłem działać, zbudowałem dwa pancerniki - jeden w świecie macierzystym, drugi w sektorze I kręgu. Paweł W natomiast zbudował dwa monolity.<br><br>
    ...
    <li><h3>Runda 9</h3></li>
    <div>
    <img src="/images/sesje/13122025/24.webp"></img>
    ...
    Przystąpiłem do analizy sytuacji na planszy. Paweł W z Tymkiem mieli wyraźnie lepszą pozycję, Tymek nieco bardziej widoczną, ale Exiles mimo, że mieli tylko 4 heksy to jednak każdy z nich był wart conajmniej 5 punktów dla Pawła, a jego domowy heks nawet 7 punktów. To jest 22 punkty leżące na mapie. To bardzo dużo. Zachęciłem więc Piotra by zaatakował Exiles, co uczynił, wysłał wszystko co miał na ich dwa heksy i to był początek lawiny ruchów i manewrów, pozycje statków nie ustannie się zmieniały. W pewnym momencie ja, Natan, Piotr i Kacper namawialiśmy Tymka by zaatakował Pawła W na jego dwa słabo bronione heksy, warte łącznie 11 punktów, ale nie dał się przekonać, ja sam nie miałem jak się przedostać do Pawła W by go zaatakować, niestety.<br><br>
    Statki latały w te i wewte. Ostatecznie na koniec rundy przed fazą walki sytuacja wyglądała następująco:<br><br>
    Dorado - zaatakowałem pancernikiem heks z dwoma Starożytnymi, by zdobyć heks wart 2 punkt oraz żeton odkrycia o takiej samej wartości, oprócz tego zaatakowałem jeden heksów z I kręgu należący do Tymka, mój pancernik i myśliwiec vs myśliwiec i krążownik Ludzi<br><br>
    Mechanema - Natan zaatakował dwoma krążownikami i jednym pancernikiem centrum trzymane przez Tymka i bronione jednym krążownikiem. Musiał się jednak bronić przed pancernikiem i krążownikiem Tymka atakującym jego heks na I kręgu, bronił się pancernikiem i myśliwcem. Ale to nie koniec! Piotr zaatakował świat domowy Mechanemy jednym krążownikiem, więc tu była walka krążownik vs krążownik. Ale Natan nie pozostał mu dłużny, zaatakował go jednym krążownikiem na heksie, który kiedyś należał do Roju, tutaj dołączyli też Exiles, więc była walka krążownik Natana vs myśliwiec Pawła W, a na wygranego czekała walka z dwoma myśliwcami Hydran.<br><br>
    Exiles i Hydran - tu walka była zacięta, Piotr zaatakował dwa heksy Pawła W, na heksie A mieliśmy skład: Hydranie - Pancernik, krążownik, myśliwiec vs Exiles - 5 myśliwców, orbital i krążownik. Na heksie B była walka między pancernikiem, dwoma krązownikami i myśliwcem Piotra, a pancernikiem, dwoma krążownikami i dwoma myśliwcami Pawła W. Oprócz tego Exiles wysłali jeden pancernik do świata macierzystego Hydran, gdzie mieli tylko jeden myśliwiec do obrony.<br><br>
    Orion i Ludzie - Kacper zaatakował trzema krążownikami w trzech różnych miejscach, dwa heksy Tymka, z czego jeden broniony pojedynczym myśliwcem, oraz jeden heks Natana, który był bez obrony. Łącznie Ludzie zostali zaatakowani na 4 sektorach, a sami zaatakowali 1 heks.<br><br>
    Rezultat walk? Orion i Dorado wygrali swoje walki. Mechanema wygrała walkę o centrum, ale przegrała trzy inne walki. Hydranie wygrali obie walki z Mechanemą, ale przegrali wszystkie przeciw Exiles. Ludzie wygrali walkę z Mechanemą, ale przegrali wszystkie pozostałe.
    </p>
  ...
  {
    id: 10,
    game: "Adaptacja, improwizacja, konfrontacja",
    date: "2026-04-11",
...
<ol>
  <li>Natan - Octanis</li>
  <li>Kacper - Hydranie</li>
  <li>Paweł D - Mechanema</li>
  <li>Mateusz - Ludzie</li>
</ol>
<ul>
  <li>
    <h3>Runda 1</h3>
  </li>
  <img src="/images/sesje/110426/1.webp" loading="lazy" class="img-head"></img>
  <img src="/images/sesje/110426/2.webp" loading="lazy" class="img-head"></img>
  <p>W pierwszej rundzie pojawiło się sporo Starożytnych na mapie.<br><br>
    Ja grając białą Mechanemą, odkryłem heks na I i II kręgu, odkrywając statek Starożytnych, natomiast trafił mi się
  ...
  <p>Dalsze eksploracje oraz pierwsza walka.<br><br>
    Ja kupiłem technologię Improved Hull, którą wykorzystałem potem do Upgradu pancernika. Zbudowałem go i wysłałem w
    ...
    Ludzie, podobnie, odkryli dwa heksy z III kręgu, na jednym z nich byli Starożytni.<br><br>
    Octanis mieli trochę więcej szczęścia tym razem i dwa odkryte heksy nie były bronione przez Starożytnych.<br><br>
    Mechanema wygrała swoją walkę bez problemowo, choć stracili myśliwiec.
  </p>
  <li>
    <h3>Runda 3</h3>
  </li>
  <img src="/images/sesje/110426/4.webp" loading="lazy" class=""></img>
  <p>Dalszy rozwój imperiów.<br><br>
    Po podbiciu Starożytnych w poprzedniej rundy, miałem przestrzeń do dalszej eksploracji blisko centrum, gdzie
    ...
    wrażenie większego zagrożenia, a widziałem, że Natan raczej nie zdąży ich podbić przede mną.<br><br>
    Kacper dokonał eksploracji na I i III kręgu, znowu miał czyste pole, jego terytorium zbliżyło się do granic
    Mateusza. Oprócz tego wciąż rozwijał swoje technologie i robił użytek z wysokiej produkcji nauki.<br><br>
    Mateusz czując presję terytorialną ze strony Kacpra, odkrył sektor przy centrum, gdzie trafił na pojedynczego
    obcego. Ulepszył i wybudował pancernik, którego wysłał na świeżo odkryty heks.<br><br>
    Natan miał problemy ekonomiczne, które próbował ogarnąć i przygotować się pod podbicie Starożytnych w kolejnych
    rundach, jako Octanis początek ma dosyć powolny, ale nie wolno ich ignorować.<br><br>
    Wygrałem swoją walkę i wymieniłem się ambasadorami z Kacprem. Mateusz również wygrał swoją walkę i w żetonie
    odkrycia zyskał Orbital, który też skolonizował.
  </p>
  <li>
    <h3>Runda 4</h3>
  </li>
  <img src="/images/sesje/110426/5.webp" loading="lazy" class=""></img>
  <p>W galaktyce jeszcze roiło się od Starożytnych.<br><br>
    Mechanema wysłała swój jedyny pancernik przeciwko dwóm statkom Starożytnych, teraz był trochę silniejszy, ponieważ
    ...
    Octanis dalej mieli problemy z wypłacalnością (a przynajmniej tak twierdzili). Eksplorowali heks II kręgu oraz III,
    ten drugi zawierał tylko żeton odkrycia, ale przede wszystkim pozwolił na wymianę ambasadorów, co nieco pomogło
    Natanowi.
  </p>
  <li>
    <h3>Runda 5</h3>
  ...
  <p>Galaktyka została oczyszczona z Starożytnych. Został tylko pojedynczy, przy granicy Octanis i Ludzi.<br><br>
    Ja dobudowałem pancernik oraz dwa krążowniki i wysłałem dwa duże statki i jeden średni na Świat Starożytnych. Nie
    ...
    Mateusz dobudował drugi pancernik i wysłał po jednym na dwa heksy Starożytnych, dzięki czemu w jednej rundzie je
    podbił.<br><br>
    Natan zbudował w końcu dwa duże statki, pancerniki, które wysłał na podwójnych Starożytnych. To nie była łatwa
    walka, stracił jeden statek, ale ostatecznie wygrał.<br><br>
  </p>
  <li>
    <h3>Runda 6</h3>
  </li>
  <img src="/images/sesje/110426/7.webp" loading="lazy" class=""></img>
  <p>Sytuacja była krytyczna w moim imperium. Nie mając żadnych statków i za mało surowców by zbudować dwa pancerniki,
    zacząłem analizować moją sytuację. Orion, kierowany przez Kacpra, posiadał swoją flotę przy granicy ze mną, ale
    daleko od centrum, a tylko poprzez mój sektor z I kręgu można było do mnie wlecieć, w pozostałych miejscach wszędzie
    były conajwyżej połówki wormhole. Więc czułem się nie tyle bezpieczny od strony Kacpra, co wiedziałem, że zdążę
    zauważyć zbliżanie się jego floty na czas i zareagować, oh jakże naiwny wtedy byłem. GCDS wciąż okupowało środek,
    więc nic mi nie groziło z tej strony. Jedynie Mechanema stanowiła potencjalne zagrożenie, ale mieliśmy kontakty
    dyplomatyczne plus Natan odsłoniłby się na atak ze strony Hydran, gdyby mnie zaatakował. Mój plan był taki, by
    zbierać siły i nie śpieszyć się z niczym. Natan zwrócił uwagę, że chyba powinienem zbudować jakieś statki do obrony,
    nie, jest dobrze, odpowiedziałem.<br><br>
    Natan wykupił technologię Zaawansowanych Planet Ekonomicznych oraz wybudował pancernik. Jego sytuacja wyglądała na
    stabilną i rozwijał się. Piotr wybudował dwa pancerniki i krążownik. Posiadał już pokażną flotę. Paweł W odbudował
    dwa krążowniki w sektorze I kręgu. Tymek wciąż rósł w siłę nie niepokojony przez nikogo. Zbudował jeden pancernik i
    krążownik, miał więc pełny limit czterech krążowników i dwóch pancerników, z tej floty wysłał trzy statki na
    centrum. Kacper zajął heks po Roju Starożytnych zyskując żeton odkrycia oraz kupił technologię Wormhole
    Generator.<br><br>
    Tymkowi udało się zdobyć środek galaktyki, zyskał w ten sposób 8 heks pod swoją kontrolę. Posiadał najwięcej heksów
    i największą flotę na ten moment gry.<br><br>
    Ta runda była dość spokojna, prawdziwa cisza przed burzą.
  </p>
  <li>
    <h3>Runda 7</h3>
  ...
  <div>
    ...
    <img src="/images/sesje/110426/15.webp"></img>
  </div>
  <h3>Burza nadeszła...</h3>
  <p>
    Kompletnie uszło mojej uwadze to, że Kacper w poprzedniej rundzie kupił technologię Wormhole Generator i ustawił
    swoje krążowniki tak, by teraz wlecieć na moje dwa heksy jednym ruchem. Manewr kompletnie mnie zaskoczył i złapał na
    opuszczonej gardzie. Choć to był dobry pomysł, ale moim zdaniem wykorzystany przeciwko nie temu graczowi, co trzeba,
    nie byłem faworytem do wygranej, więc to było kopanie leżącego. Sam Kacper powiedział, że raczej nie ma szans na
    jego wygraną, to trochę potrolluje. Dyskusyjne podejście. W dalszej części rundy Orion dobudował dwa krążowniki,
    jeden wysłał do pomocy na atak na tyły mojego imperium, a drugi miał samodzielnie zdobyć mój sektor w I kręgu, ale
    tu czekał na niego już Tymek ze swoim krążownikiem. Tymek wysłał też drugi krążownik przez moje imperium aż do heksa
    gdzie było dwóch Starożytnych. Natan skomentował to, że wciąż nie zbudowałem żadnego statku, czy zamierzam w ogóle
    się bronić bo chyba najwyższa pora. Spoko spoko, dobrze jest, kupiłem rzadką technologię Neutron Absorber, broniącą
    przed bombami neutronowymi. Mechanema międzyczasie wysłała krążownik na wolny heks za światem ojczystym. Po drugiej
    stronie galaktyki był spokój.<br><br>
    Straciłem dwa heksy z III kręgu, z powodu ataku Oriona. W sektorze z I kręgu natomiast stoczyła się walka 1vs1,
    którą wygrał Tymek, niestety dla niego, nie był w stanie zająć mojego heksu, bo nie udał mu się atak na populację.
    Stracił też krążownik w walce ze Starożytnymi, którzy wyszli z tego bez strat. Słabe efekty jak na tak śmiałe ruchy.
  </p>
  <li>
    <h3>Runda 8</h3>
  </li>
  <div>
    <img src="/images/sesje/110426/17.webp"></img>
    <img src="/images/sesje/110426/18.webp"></img>
    <img src="/images/sesje/110426/19.webp"></img>
  </div>
  <h3>Burza przybierała na sile...</h3>
  <p>
    Kacper wleciał jednym krążownikiem na mój ostatni heks z III kręgu, a drugim na mój świat macierzysty. Ja w tym
    czasie po analizie schematów statków innych graczy kupiłem technologię Flux Missile, tanie, szybkie rakiety o małej
    sile rażenia, ale pozostali gracze mieli statki o małej ilość punktów życia, więc te rakiety powinny wystarczyć.
    Natan poleciał krążownikiem i pancernikiem na mój sektor I kręgu, gdzie wciąż był krążownik Tymka. Pancernikiem
    później poleciał dalej, do Kacpra, który desperacko bronił się budując Bazę Gwiezdną. Ja zacząłem działać,
    zbudowałem dwa pancerniki - jeden w świecie macierzystym, drugi w sektorze I kręgu. Paweł W natomiast zbudował dwa
    monolity.<br><br>
    Z trzech moich heksów, które zostały zaatakowane, wszystkie się obroniły: III krąg obronił się dzięki Neutron
    Absorber, Kacper nie był w stanie zniszczyć mojej populacji na planetach. I krąg i świat domowy zostały obronione
    przez pancerniki. Pancernik Natana wygrał walkę z Bazą Gwiezdną Kacpra.</p>
  <li>
    <h3>Runda 9</h3>
  </li>
  <div>
  ...
  <p>
    ...
    większe szanse na wygraną. Zgodził się i wycofał się, więc wymieniliśmy się ambasodorami, co zaskoczyło niektórych.
    W końcu Kacper od dwóch rund atakował mnie, ale nie chciałem żywić urazę, bo w żaden sposób by to nie poprawiło
    mojej sytuacji. Wybudowałem dwa myśliwce z nadzieją na jakąś okazję i nie broniony heks, lub też do pomocy przy
    wiązaniu walką w razie czego.<br><br>
    Przystąpiłem do analizy sytuacji na planszy. Paweł W z Tymkiem mieli wyraźnie lepszą pozycję, Tymek nieco bardziej
    widoczną, ale Exiles mimo, że mieli tylko 4 heksy to jednak każdy z nich był wart conajmniej 5 punktów dla Pawła, a
    jego domowy heks nawet 7 punktów. To jest 22 punkty leżące na mapie. To bardzo dużo. Zachęciłem więc Piotra by
    zaatakował Exiles, co uczynił, wysłał wszystko co miał na ich dwa heksy i to był początek lawiny ruchów i manewrów,
    pozycje statków nie ustannie się zmieniały. W pewnym momencie ja, Natan, Piotr i Kacper namawialiśmy Tymka by
    zaatakował Pawła W na jego dwa słabo bronione heksy, warte łącznie 11 punktów, ale nie dał się przekonać, ja sam nie
    miałem jak się przedostać do Pawła W by go zaatakować, niestety.<br><br>
    Statki latały w te i wewte. Ostatecznie na koniec rundy przed fazą walki sytuacja wyglądała następująco:<br><br>
    Dorado - zaatakowałem pancernikiem heks z dwoma Starożytnymi, by zdobyć heks wart 2 punkt oraz żeton odkrycia o
    takiej samej wartości, oprócz tego zaatakowałem jeden heksów z I kręgu należący do Tymka, mój pancernik i myśliwiec
    vs myśliwiec i krążownik Ludzi<br><br>
    Mechanema - Natan zaatakował dwoma krążownikami i jednym pancernikiem centrum trzymane przez Tymka i bronione jednym
    krążownikiem. Musiał się jednak bronić przed pancernikiem i krążownikiem Tymka atakującym jego heks na I kręgu,
    bronił się pancernikiem i myśliwcem. Ale to nie koniec! Piotr zaatakował świat domowy Mechanemy jednym krążownikiem,
    więc tu była walka krążownik vs krążownik. Ale Natan nie pozostał mu dłużny, zaatakował go jednym krążownikiem na
    heksie, który kiedyś należał do Roju, tutaj dołączyli też Exiles, więc była walka krążownik Natana vs myśliwiec
    Pawła W, a na wygranego czekała walka z dwoma myśliwcami Hydran.<br><br>
    ...
    pancernikiem, dwoma krązownikami i myśliwcem Piotra, a pancernikiem, dwoma krążownikami i dwoma myśliwcami Pawła W.
    Oprócz tego Exiles wysłali jeden pancernik do świata macierzystego Hydran, gdzie mieli tylko jeden myśliwiec do
    obrony.<br><br>
    Orion i Ludzie - Kacper zaatakował trzema krążownikami w trzech różnych miejscach, dwa heksy Tymka, z czego jeden
    broniony pojedynczym myśliwcem, oraz jeden heks Natana, który był bez obrony. Łącznie Ludzie zostali zaatakowani na
    4 sektorach, a sami zaatakowali 1 heks.<br><br>
    Rezultat walk? Orion i Dorado wygrali swoje walki. Mechanema wygrała walkę o centrum, ale przegrała trzy inne walki.
    Hydranie wygrali obie walki z Mechanemą, ale przegrali wszystkie przeciw Exiles. Ludzie wygrali walkę z Mechanemą,
    ale przegrali wszystkie pozostałe.
  </p>
  ...
  <p class="session-summary">
    <b>Podsumowanie AI:</b><br><br>
    <b>Paweł D (Dorado)</b>: Twój styl gry to mistrzostwo w adaptacji i przetrwaniu. Po początkowym, kosztownym szturmie
    na centrum i chwilowym upadku, odbudowałeś się dzięki zimnej krwi, strategicznemu wykorzystaniu technologii (Neutron
    Absorber, Flux Missile) i pragmatycznej dyplomacji. Twoja zdolność do wyjścia z kryzysu i włączenia się do wielkiej
    wojny, aby zdobywać punkty i osłabiać liderów, pokazuje cię jako nieprzewidywalnego i odpornego gracza.<br><br>
    ...
    <b>Paweł W (Exiles)</b>: Jesteś ucieleśnieniem mocy defensywy i precyzyjnej kalkulacji. Zbudowałeś najmniejsze, ale
    najcenniejsze imperium, oparte na orbitalach i wysokiej wartości punktowej. Twoja „partyzantka” przeciwko Dorado i
    heroiczna obrona przed Hydranami udowodniły, że twoje terytorium jest niemal nie do zdobycia. Wychodząc z totalnej
    wojny nienaruszy, z honorem dotrzymanych sojuszy, stałeś się głównym faworytem do zwycięstwa.<br><br>
    ...
    że twoja materialna przewaga wyparowała pod skoordynowanym naciskiem reszty galaktyki. Straciłeś kluczowe tereny, w
    tym centrum, i z faworyta stałeś się graczem walczącym o utrzymanie pozycji.<br><br>
    ...
    wrogiem. Twoje działania, choć czasem „trollujące” i niekonwencjonalne, były niezwykle skuteczne w mieszaniu szyków
    innym, poprawianiu własnej sytuacji i wpływaniu na dynamikę całej galaktyki.<br><br>
    <b>Podsumowanie rozgrywki:</b><br><br>
    ...
    przetrwania i odbudowy. Finałowa, totalna wojna całkowicie zmiotła początkowy układ sił, wynosząc na czoło cichego,
    ufortyfikowanego budowniczego. Ostateczne zwycięstwo nie będzie należeć do tego, kto miał najwięcej statków, lecz do
    tego, kto najlepiej zabezpieczył swoje punkty i przetrwał zamęt, który sam wywołał lub w którym się odnajdzie.
  </p>
